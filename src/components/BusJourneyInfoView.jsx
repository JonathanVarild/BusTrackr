    ...
    return (
      <div id={styles.infoContainer}>
        <div id={styles.infoTitleContainer}>
          <h3>
            <span className={`${getBusColorStyle(props.journeyDetails.line)} ${styles.lineSpan}`}>
              {props.journeyDetails.line ? props.journeyDetails.line : "-"}
            </span>
            &nbsp;
        ...
        <div className={styles.busInfoConatainer}>
          ...
          <div id={styles.containerCapacity} className={styles.infoContainerOuter}>
            ...
            <div className={styles.infoContainerInner}>
              <p>Capacity:</p>
              <p>{props.journeyDetails.seated ?
                props.journeyDetails.seated + props.journeyDetails.standing
                :
                "-"
              }</p>
            </div>
          ...
          <div id={styles.containerOperator} className={styles.infoContainerOuter}>
            ...
            <div className={styles.infoContainerInner}>
              <p>Operator:</p>
              <p>{ props.journeyDetails.operator ?
                props.journeyDetails.operator
                :
                "-"
              }</p>
            </div>
